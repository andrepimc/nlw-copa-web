...
import { getPositionOfLineAndCharacter, isConstructorDeclaration } from 'typescript';
...
export default function Home(props: HomeProps) {
  ...
  return (
    <div className="max-w-[1124px] h-screen mx-auto grid grid-cols-2 gap-28 items-center">
      ...
      <Image 
      src={appPreviewImg} 
      alt="Dois celulares exibindo um previa da aplicacao movel do nlw copa " 
      quality={100}
      />
    </div>
  )
 ...
 export const getServeSideProps = async() =>{
  const [poolCountResponse, guessCountResponse, userCountResponse ] = await Promise.all([
    api.get('pools/counts'),
    api.get('guesses/counts'),
